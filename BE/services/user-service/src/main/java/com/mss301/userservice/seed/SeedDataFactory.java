...
public final class SeedDataFactory {
    ...
    public static List<SeedUser> users() {
        ...
        return List.of(
                user(
                        ...
                        nutrition(GoalType.MAINTAIN, "65", 12, "0.00", "2500", "2500", "150", "300", "70"),
                ...
                user(
                        ...
                        nutrition(GoalType.LOSE_WEIGHT, "68", 24, "0.50", "1500", "1500", "90", "150", "45"),
                ...
                user(
                        ...
                        nutrition(GoalType.GAIN_WEIGHT, "95", 20, "0.25", "3000", "3000", "170", "350", "90"),
                ...
                user(
                        ...
                        nutrition(GoalType.MAINTAIN, "48", 12, "0.00", "1800", "1800", "80", "220", "55"),
                ...
                user(
                        ...
                        nutrition(GoalType.MAINTAIN, "60", 12, "0.00", "1600", "1600", "70", "180", "50"),
                ...
                user(
                        ...
                        nutrition(GoalType.LOSE_WEIGHT, "72", 16, "0.38", "2200", "2200", "100", "260", "65"),
                ...
                user(
                        ...
                        nutrition(GoalType.GAIN_WEIGHT, "62", 16, "0.25", "2100", "2100", "95", "250", "60"),
                ...
                user(
                        ...
                        nutrition(GoalType.MAINTAIN, "72", 12, "0.00", "2600", "2600", "150", "300", "75"),
                ...
                user(
                        ...
                        nutrition(GoalType.LOSE_WEIGHT, "62", 12, "0.50", "1900", "1900", "100", "210", "60"),
                ...
                user(
                        ...
                        nutrition(GoalType.MAINTAIN, "74", 12, "0.00", "2000", "2000", "110", "230", "65"),
    ...
    private static SeedNutritionGoal nutrition(
        ...
        return new SeedNutritionGoal(
                ...
                new BigDecimal(recommendedCalories),
                new BigDecimal(dailyCaloriesGoal),

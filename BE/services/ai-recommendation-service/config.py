...
class Settings:
    ...
    persist_recommendations: bool = os.getenv("AI_PERSIST_RECOMMENDATIONS", "false").lower() == "true"
    chroma_path: str = os.getenv("CHROMA_PATH", str(Path(__file__).resolve().parent / ".chroma"))
    ...
    llm_strict: bool = os.getenv("AI_LLM_STRICT", "false").lower() == "true"
